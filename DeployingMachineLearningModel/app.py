...
def main():
    ...
    select_page = st.sidebar.selectbox("About or Prediction", ("About", "Prediction"), key = "option1")

    
    if (select_page == 'About'):
        about()
        
    elif (select_page == 'Prediction'):
        explore_webapp_page()
...
def about():
    ...
    show_feature_importance_plot(trained_model)
