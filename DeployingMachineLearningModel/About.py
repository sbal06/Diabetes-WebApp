...
st.subheader("For the best visual experience and to access the Machine Learning model, Research Based model, and Personalized Meal plans, please use a computer or desktop.", divider = 'gray')
