...
st.write("The model results will be presented in four categories: Low Risk, Moderate Risk, High Risk, and Very High Risk for three types of diabetes: Type 1, Type 2, and Gestational.")
