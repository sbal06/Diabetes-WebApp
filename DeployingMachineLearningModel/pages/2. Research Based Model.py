...
question9y = selectbox("Have you been experiencing prolonged levels of stress lately?", ("Yes", "No"), key = "stress")
if (question9y == "Yes"):
    type1 = type1 + weights['smoke_alcohol_stress_hp']
    type2 = type2 + weights['smoke_alcohol_stress_hp']
    if (question1 == "Female" and (subq1 == "Yes")):
...
with stylable_container(
    ...
    css_styles="""
        ...
        research_based_model = st.button("Diabetes Test Result")

if (research_based_model):
...
st.write("The model results will be presented in four categories: Low Risk, Moderate Risk, High Risk, and Very High Risk for each of the three types of diabetes: Type 1, Type 2, and Gestational.")
