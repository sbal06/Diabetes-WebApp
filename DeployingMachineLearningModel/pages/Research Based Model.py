...
type2 = 0
gestational = 0
st.subheader("Please fill out this survey!")
...
question7 = selectbox("What race or ethnicity do you indentify as?", ("White", "Non-white"), key = "race")
...
if (st.button("Diabetes test result")):
    if (not question1 or not question2 or not question3Weight or not question3Height or not question4 or not question5 or not question6 or not question7 or not question8 or not question9 or not question10 or not question11):
        ...
        for string, value in zip(diabetesString, diabetesValue): # possible way to iterate two iterables parallelly  
            if (values_list[0] <= value < values_list[1]):
