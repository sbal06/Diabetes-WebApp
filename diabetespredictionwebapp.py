...
current_directory = os.path.dirname(os.path.realpath(r"C:\Users\shrey\Downloads\DeployingMachineLearningModel"))
model_path = os.path.join(current_directory, r"C:\Users\shrey\Downloads\DeployingMachineLearningModel\trained_model.sav")
load_model = pickle.load(open(model_path, 'rb'))


model_path2 = os.path.join(current_directory, r"C:\Users\shrey\Downloads\DeployingMachineLearningModel\best_estimator.pkl")
